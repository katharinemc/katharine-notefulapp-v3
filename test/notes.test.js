...
describe('notes router testing', function () {
  ...
  describe('POST /api/notes', function () {
    it('should not create a new note, when provided with invalid keys', function () {
      const badItem = {
        'one': 'The best article about cats ever!',
    ...
    it('should create and return a new item when provided valid data', function () {
      ...
      return chai.request(app)
        ...
        .then(data => {
          console.log(typeof data.folderId, typeof res.body.folderId);

          expect(res.body.title).to.equal(data.title);
          expect(res.body.content).to.equal(data.content);
          // expect(JSON.stringify(res.body.folderId)).to.equal(data.folderId);
        });
    });
  });
